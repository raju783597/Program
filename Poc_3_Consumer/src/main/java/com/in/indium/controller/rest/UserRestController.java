...
import com.in.indium.Poc3Comsumer;
import com.in.indium.consumer.RoleRestConsumer;
...
public class UserRestController {
	...
	@Autowired
	private RoleRestConsumer consumer;
	
	@GetMapping("/consume")
	public String findMassage() {
		log.info("START THE CONSUMER");
		log.info(" FINISHED THE CONSUMER URL");
		return "CONSUMER=>"+consumer.doHttpcall()+"..FROM PRODUCER";
